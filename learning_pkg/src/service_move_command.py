...
#import time
import rospy
from learning_pkg.srv import MoveCommandMessage, MoveCommandMessageResponse
import numpy as np
...
def my_callback(choise):
    ...
    return MoveCommandMessageResponse(success)


example = ExampleMoveItTrajectories()
rospy.init_node('service_move_command')
my_service = rospy.Service('/move_command', MoveCommandMessage, my_callback)
